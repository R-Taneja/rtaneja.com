  ...
  return (
    <FadeIn>
      <div className='homePage'>
        ...
        <h3 className='subtitle'>AI @ Vercel • <a href="https://met.berkeley.edu" rel="noreferrer" target="_blank" style={{ textDecoration: "none", color: "blue" }}>UC Berkeley M.E.T.</a> Alum</h3>
