    ...
    <FadeIn>
      <div className='projectsPage'>
          ...
          <div className="projects">
            ...
            <Project title='Drop-In CSS Generator' description='Generate custom drop-in CSS files to style simple websites instantly' language='</>  React' link='https://www.dropincss.com' logo={dropInCSS} />
