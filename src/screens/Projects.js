    ...
    <FadeIn>
      <div className='projectsPage'>
          ...
          <div className="projects">
            ...
            <Project title='Rapid Test Collector' description='Host events safely by collecting COVID-19 test results from attendees' language='</>  React' link='https://www.rapidtestcollector.com' logo={rapidTestLogo} />
