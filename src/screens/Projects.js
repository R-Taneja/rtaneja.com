    ...
    <FadeIn>
      <div className='projectsPage'>
          ...
          <div className="projects">
            ...
            <Project title='Rapid Test Collector' description='Host events safely with this tool to collect COVID-19 rapid test results from attendees' language='</>  React' link='https://www.rapidtestcollector.com' logo={rapidTestLogo} />
