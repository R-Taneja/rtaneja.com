    ...
    <FadeIn>
      <div className='projectsPage'>
          ...
          <div className="projects">
            ...
            <Project title='Rapid Test Collector' description='A tool to collect and verify COVID-19 rapid test results' language='</>  React' link='https://www.rapidtestcollector.com' />
